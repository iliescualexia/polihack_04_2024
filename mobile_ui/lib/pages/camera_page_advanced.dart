...
class CameraPageAdvanced extends StatefulWidget {
  const CameraPageAdvanced({Key? key}) : super(key: key);

  @override
  _CameraPageAdvancedState createState() => _CameraPageAdvancedState();
}

class _CameraPageAdvancedState extends State<CameraPageAdvanced> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      await _audioPlayer.setSourceAsset('sound/crowd_hard.mp3');
    });
    super.initState();
  }
